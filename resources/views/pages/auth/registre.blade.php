    ...
    <div class="register-box" style="width:450px">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('post_registre') }}" method="post">
                    @csrf
                    <label>Nom d'utilisateur <span class="text-danger">*</span></label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name="nom" autocomplet="off" placeholder="Entrer le nom d'utilisateur">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" class="form-control" name="email" placeholder="Entrer l'adresse email">
                        <div class="input-group-append">
                            <div class="input-group-text">
